...
function App() {
  ...
  return (
    <main className='bg-light-gray min-h-screen flex flex-col items-center mx-auto max-w-[90rem]'>
      <form onSubmit={handleSubmit} className=' bg-white max-w-[52.5rem]'>
        ...
        <button type="submit" className='bg-red-500 mt-[-2rem] ml-[15rem] md:mt-0 md:ml-0'><img src='/images/icon-arrow.svg'/></button>
        </div>
        <div>
      <div>
      <p>{age.years} years</p> 
